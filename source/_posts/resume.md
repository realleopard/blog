...
#### 项目描述
集异构数据采集，数据存储，离线计算，实时计算，数据报表，实时查询等为一体的大数据平台
...
### 游戏数据分析  								 
#### 项目描述
基于大数据平台，将公司所有的游戏数据接入到大数据平台，开发出一套可视化游戏数据分析平台，包括用户分析，收入分析，运营系统，客服系统，查询系统等
